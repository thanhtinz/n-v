    ...
    <div className="space-y-4">
      ...
      <Tabs defaultValue="fishing" className="w-full">
        <TabsList className="grid w-full grid-cols-4">
          <TabsTrigger value="fishing">Câu Cá</TabsTrigger>
          <TabsTrigger value="gambling">Cờ Bạc</TabsTrigger>
          <TabsTrigger value="chess">Cờ Tướng</TabsTrigger>
          <TabsTrigger value="wish">Ước Nguyện</TabsTrigger>
        </TabsList>
