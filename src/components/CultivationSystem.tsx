  ...
  return (
    <div className="space-y-4">
      ...
      {offlineRewards.timeAway > 0 && (
        <Card className="p-4 border-cultivator-gold/50 bg-gradient-gold/10">
          <div className="text-center space-y-2">
            <h3 className="text-lg font-bold text-cultivator-gold">Tu Luyện Ngoại Tuyến</h3>
            ...
            <Button onClick={claimOfflineRewards} className="gradient-gold text-black">
              Nhận Thưởng
            </Button>
          </div>
        </Card>
      ...
      <Card className="p-6 bg-card/80 backdrop-blur-sm border-border/50">
        <div className="space-y-4">
          {/* Realm Display */}
          <div className="text-center space-y-2">
            <Badge variant="outline" className="px-4 py-2 text-lg border-cultivator-gold text-cultivator-gold">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex items-center justify-center gap-2 p-3 bg-muted/30 rounded-lg">
              <Gem className="w-5 h-5 text-spirit-jade" />
              <span className="font-medium">{cultivation.spiritStones}</span>
              <span className="text-xs text-muted-foreground">Linh Thạch</span>
            </div>
            <div className="flex items-center justify-center gap-2 p-3 bg-muted/30 rounded-lg">
              <Zap className="w-5 h-5 text-cultivator-gold" />
              <span className="font-medium">{cultivation.cultivationSpeed}/s</span>
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button
              ...
              className="cultivate-anim"
            >
              <Clock className="w-4 h-4 mr-2" />
              {cultivation.isAutoTraining ? 'Dừng Tu Luyện' : 'Tự Động Tu Luyện'}
            </Button>
            <Button
              onClick={manualCultivate}
              disabled={cultivation.spiritStones < 1}
              className="gradient-jade text-black"
            >
              <TrendingUp className="w-4 h-4 mr-2" />
              Tu Luyện (1 Linh Thạch)
            </Button>
          </div>
